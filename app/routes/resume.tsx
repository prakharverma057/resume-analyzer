    ...
    <main className="!pt-0">
      <nav className="resume-nav">
        <Link to="/" className="back-button">
          ...
          <span className="text-gray-8900 text-sm font-semibold">
            Back to Homepage
          </span>
        </Link>
      </nav>
      <div className="flex flex-row w0full max-lg:flex-col-reverse">
        ...
        <section className="feedback-section">
          ...
          {feedback ? (
            <div className="flex flex-col gap-8 annimate-in fade-in duration-1000">
